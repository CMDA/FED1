...
Welke archetypes staan in het artikel beschreven?   The enthusiast, understand the principles of code, and no more   The mash-up artist, people whose code curiosity has blossomed   The inventor,  knows at least one language to write code from scratch   The wizard, are the developers that you respect and admire, kunnen alles, weten alles  
Welk type ben jij of wil je worden? En waarom?   Geef een beschrijving van het type  
...
__Pagina valideren, kijken wat er gebeurt:__  
